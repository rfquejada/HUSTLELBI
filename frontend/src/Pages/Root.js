...
function Root ()
{
    ...
    const [freelancers, setFreelancers] = useState([
...

        {
            ...
            service_type: ["lab assistance", "tutorials"],
...

        {
            ...
            service_type: ["essay writing ", "presentation "],
            usual_availability: ["Monday", "Wednesday"],
            history: [3, 4]
        },
    ...
    const [jobPostings, setJobPostings] = useState([
...

        {
            ...
            ClientReview: "Quick and professional!",
            type: ["errands"],
            clientId: 2,
            freelancerId: 2,
            ratingFree: 4.5,
...

        {
            ...
            ClientReview: "Very helpful during the study session!",
...

        {
            ...
            ClientReview: "Highly organized and efficient.",
            type: ["academic assistance"],
            clientId: 8,
            freelancerId: 8,
            ratingFree: 4.9,
